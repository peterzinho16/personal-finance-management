...
CREATE TYPE income_sources AS ENUM ('Salario neto', 'Freelance','CTS', 'Gratificacion', 'Bonus', 'Utilidades', 'Monto de pago compartido');
...
-- Step 1: Create the ENUM type for currency
CREATE TYPE currency_type AS ENUM ('PEN', 'USD');

-- Step 2: Add the column to the table
ALTER TABLE incomes ADD COLUMN currency currency_type NOT NULL DEFAULT 'PEN';
