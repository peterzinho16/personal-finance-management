...
public class Utilities {
  ...
  public static String generateSha256FromMailContent(LocalDateTime transactionDate, String subject) throws NoSuchAlgorithmException {
    String timestamp = transactionDate.format(DateTimeFormatter.ISO_DATE_TIME);
    String flSting = timestamp + subject;
